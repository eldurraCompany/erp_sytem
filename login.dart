...
class _LoginState extends State<Login> {
                    ...
                    child: Column(children: <Widget>[
                      ...
                      Container(
                        ...
                        child: TextButton(
                            ...
                            onPressed: () async {
                              print(
                                  "hna login ${await Helper().checkConnectivity()}");
                              if (await Helper().checkConnectivity()) {
                                if (_formKey.currentState!.validate() &&
                                  ...
                                  print("hna respone ${loginResponse}");

                                  if (loginResponse?['success'] != null &&
                                      loginResponse!['success']) {
                                    Config.updateClientHandled(true);
                                    ...
                                    if (loginResponse?['error'] ==
                                        'invalid_client') {
                                      Config.clearClientCredentials();
                                      Config.updateClientHandled(false);
  ...
  Future<void> showLoadingDialogue() async {
   ...
   // signingConfigs {
    //     // Only create a debug signing config (optional, Flutter provides one by default)
    //     getByName("debug") {
    //         // no need to set storeFile, keyAlias, etc.
    //     }
    // }

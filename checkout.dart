...
class CheckOutState extends State<CheckOut> {
  ...
  bool _printInvoice = true,
      ...
      saleCreated = false,
      isLoading = false;
  bool _paymentsInitialized = false;
  ...
  setPaymentAccounts() async {
    ...
    await System().getPaymentAccounts().then((value) {
      ...
      value.forEach((element) {
        ...
        print("hna setPaymentAccounts2 ${paymentAccounts.length}");
        // print('hna paymentspayments ${payments.length}');
      });
    });
  }
  ...
  void didChangeDependencies() {
    ...
    if (_paymentsInitialized) return;
        ...
        children: <Widget>[
          ...
          ListView.builder(
              ...
              itemBuilder: (context, index) {
                print("hna payments ${payments.length}");
                print("hna payments ${index}");
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                  ...
                                  child: ExpansionTile(
                                    ...
                                    controller: payments[index]['controller'],
                                    initiallyExpanded: _expandedIndex ==
                                        index, // 👈 expand only if selected
                                    onExpansionChanged: (expanded) {
                                      setState(() {
                                        _expandedIndex = expanded
                                            ? index
                                            : null; // 👈 close if tapped again
                                      });
                                    },
                                    title: Text(
                                    ...
                                    children:
                                        paymentMethods.map<Widget>((value) {
                                      return ListTile(
                                        title: Text(
                                          value['value'], // visible label
                                          style: AppTheme.getTextStyle(
                                            themeData.textTheme.bodyLarge,
                                            color: themeData
                                        ...
                                        onTap: () {
                                          ...
                                          // Close the ExpansionTile after selection
  ...
  setPaymentDetails() async {
    List paymentsFromSystem =
        await System().get('payment_method', argument!['locationId']);
    List<Map> newPaymentMethods = [];
    paymentsFromSystem.forEach((element) {

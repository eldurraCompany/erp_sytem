      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: AppTheme.getTextStyle(
            themeData.textTheme.titleLarge, // ✅ instead of headline6
            fontWeight: 600,
            color: themeData.colorScheme.primaryContainer, // ✅ replaces primaryVariant
          ),
        ),
      ),
                      ...
                      Row(
                        children: [
                          Text(
                            ...
                            style: AppTheme.getTextStyle(
                              themeData.textTheme.titleMedium, // ✅ instead of headline6
                              fontWeight: 600,
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: AppTheme.getTextStyle(
                                    themeData.textTheme.titleMedium, // ✅ subtitle1 -> titleMedium
                                    fontWeight: 600,
                                    color: themeData.colorScheme.primaryContainer,
                                  ),
                                ),
                                Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    style: AppTheme.getTextStyle(
                                      themeData.textTheme.bodyLarge, // ✅ bodyText1 -> bodyLarge
                                      fontWeight: 500,
        ...
        return DropdownMenuItem<String>(
            ...
            child: SizedBox(
              ...
              child: Text("${value['name']} (${value['mobile'] ?? ' - '})",
                  ...
                  style: AppTheme.getTextStyle(themeData.textTheme.bodyMedium, // ✅ bodyText2 -> bodyMedium
                      color: themeData.colorScheme.onSurface)),
            ));
      }).toList(),

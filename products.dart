...
class _ProductsState extends State<Products> {
  ...
  getPermission() async {
    if (await Helper().getPermission("direct_sell.access")) {
      print("hna productsView 0");
      canAddSell = true;
    }
    if (await Helper().getPermission("product.view")) {
      print("hna productsView ");
    ...
    setState(() {
      ...
      locationListMap.forEach((element) {
        if (element['id'] == selectedLocationId &&
          ...
          // print("hna pricesGroup ${_priceGroupMenuItems.length}");
          // print("hna pricesGroup ${_priceGroupMenuItems[0].value}");
          // print("hna pricesGroup ${_priceGroupMenuItems[1]}");
        }
      });
    });
  }
            ...
            Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton(
                    ...
                    value: _priceGroupMenuItems
                            .any((item) => item.value == usePriceGroup)
                        ? usePriceGroup
                        : null,
                    // usePriceGroup,
      ...
      value.forEach((element) {
        if (element['is_active'].toString() == '1') {
          setState(() {
            ...
            print("hna getlocationList ${locationListMap.length}");
          });
        }
      });
    ...
    return DropdownButtonHideUnderline(
      child: DropdownButton(
          ...
          items: locationListMap.map<DropdownMenuItem<int>>((Map value) {
            print("hna value000 ${locationListMap.length}");
            // for (var item in locationListMap) {
            //   print("item ${item.keys.first}");
            //   print("item ${item.values.first}");
            // }
            // print("hna value000 ${locationListMap[0]}");
            // print("hna value000 ${locationListMap[1]}");
            // print("hna value000 ${locationListMap[2]}");
          ...
          onTap: () {
            print("hna value001 ${locationListMap.length}");
            if (locationListMap.length <= 2) {
              canChangeLocation = false;
              print("hna value001 canChangeLocation $canChangeLocation");
            }
          },
          onChanged: (int? newValue) async {
            ...
            if (canChangeLocation) {
              print("hna value001 canChangeLocation $canChangeLocation");
              print("hna value001 canChangeLocation $selectedLocationId");
              print("hna value001 canChangeLocation $selectedLocationId");
              print("hna value001 canChangeLocation $newValue");
